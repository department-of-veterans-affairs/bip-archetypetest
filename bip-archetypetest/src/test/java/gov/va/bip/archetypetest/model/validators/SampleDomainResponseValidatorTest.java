...
import gov.va.bip.archetypetest.exception.ArchetypeTestServiceException;
...
public class SampleDomainResponseValidatorTest {
    ...
    public void testValidate_HasWarnings() {
        // Setup
        SampleDomainResponse sampleDomainResponse = createSampleDomainResponse();
        sampleDomainResponse.addMessage(MessageSeverity.WARN, HttpStatus.OK, ArchetypeTestMessageKeys.BIP_SAMPLE_SERVICE_IMPL_RESPONDED_WITH_MOCK_DATA,
                "");
        List<ServiceMessage> messagesList = new ArrayList<>();
    ...
    public void testValidate_IsNull() {
        ...
        } catch (ArchetypeTestServiceException e) {
            // Verifications
            assertEquals(ArchetypeTestMessageKeys.BIP_SAMPLE_REQUEST_NOTNULL.getKey(), e.getExceptionData().getKey());
    ...
    public void testValidate_PidInconsistent() {
        ...
        assertEquals(ArchetypeTestMessageKeys.BIP_SAMPLE_REQUEST_PID_INCONSISTENT.getKey(), messagesList.get(0).getKey());
        ...
        assertEquals(ArchetypeTestMessageKeys.BIP_SAMPLE_REQUEST_PID_INVALID.getKey(), messagesList.get(1).getKey());
    }

...
public class ArchetypeTestServiceImplTest {

    ArchetypeTestServiceImpl instance;
...
*/
    ...
    @Before
    public void setUp() {
        instance = new ArchetypeTestServiceImpl();

        MockitoAnnotations.initMocks(this);

        try {
            ArchetypeTestTestUtils.setFinalStatic(ArchetypeTestServiceImpl.class.getDeclaredField("LOGGER"), mockBipLogger);
        } catch (Exception e) {
    ...
    public void testSampleFindByParticipantID_UnCached() {
        ...
        expectedServiceMessageKeys.add(ArchetypeTestMessageKeys.BIP_SAMPLE_SERVICE_IMPL_RESPONDED_WITH_MOCK_DATA.getKey());
        expectedServiceMessageKeys.add(ArchetypeTestMessageKeys.BIP_SAMPLE_SERVICE_DATABASE_CALL_PERFORMED.getKey()); // Add for the DB component branch
        expectedServiceMessageKeys.add(ArchetypeTestMessageKeys.BIP_SAMPLE_SERVICE_IMPL_RESPONDED_WITH_PARTNER_MOCK_DATA.getKey()); // Add for the Partner component branch
    ...
    public void testSampleFindByParticipantID_UnCached_NoData() {
        ...
        Set<String> expectedServiceMessageKeys = new HashSet<>();
        expectedServiceMessageKeys.add(ArchetypeTestMessageKeys.BIP_SAMPLE_SERVICE_IMPL_RESPONDED_WITH_MOCK_DATA.getKey());
        expectedServiceMessageKeys.add(ArchetypeTestMessageKeys.BIP_SAMPLE_SERVICE_DATABASE_CALL_RETURNED_NULL.getKey()); // Add for the DB component branch
        expectedServiceMessageKeys.add(ArchetypeTestMessageKeys.BIP_SAMPLE_SERVICE_IMPL_RESPONDED_WITH_PARTNER_MOCK_DATA.getKey()); // Add for the Partner component branch
    ...
    public void testSampleFindByParticipantID_UnCached_Exception() {
        // Setup
        SampleDomainRequest sampleDomainRequest = createSampleDomainRequest();
        BipRuntimeException expectedRuntimeException = new BipRuntimeException(MessageKeys.BIP_GLOBAL_GENERAL_EXCEPTION,
        ...
        Set<String> expectedServiceMessageKeys = new HashSet<>();
        expectedServiceMessageKeys.add(ArchetypeTestMessageKeys.BIP_SAMPLE_SERVICE_IMPL_RESPONDED_WITH_MOCK_DATA.getKey());
        expectedServiceMessageKeys.add(MessageKeys.BIP_GLOBAL_GENERAL_EXCEPTION.getKey()); // Add for the DB and/or Partner component branch
    ...
    public void testSampleFindByParticipantIDFallBack_Throwable() {
        ...
        assertEquals(MessageKeys.BIP_GLOBAL_GENERAL_EXCEPTION.getKey(), response.getMessages().get(0).getKey());
    }

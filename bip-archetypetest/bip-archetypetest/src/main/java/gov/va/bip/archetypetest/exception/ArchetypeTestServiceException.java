 ...
 * @author aburkholder
 */
public class ArchetypeTestServiceException extends BipRuntimeException {
	private static final long serialVersionUID = -5224277215368080694L;

	/**
	 * Constructs a new RuntimeException for the service with the specified detail key, message, severity, and status.
	 ...
	 */
	public ArchetypeTestServiceException(final MessageKey key, final MessageSeverity severity, final HttpStatus status,
			final String... params) {
